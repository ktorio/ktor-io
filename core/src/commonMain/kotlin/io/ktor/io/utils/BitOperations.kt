...
internal inline fun Short(highByte: Byte, lowByte: Byte): Short = ((highByte.toInt() shl 8) or (lowByte.toInt() and 0xff)).toShort()
internal inline fun Int(highShort: Short, lowShort: Short): Int = (highShort.toInt() shl 16) or (lowShort.toInt() and 0xffff)
internal inline fun Long(highInt: Int, lowInt: Int): Long = (highInt.toLong() shl 32) or (lowInt.toLong() and 0xffffffffL)